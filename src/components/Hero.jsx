    ...
    <section className="relative min-h-screen bg-black text-white overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-20 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 mt-6">
         <a class="font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 gap-2 group bg-white text-black shadow hover:bg-primary/90 px-16 py-5 rounded-full text-xl flex gap-x-2 items-center justify-center group w-full sm:w-[270px] h-[56px] sm:h-[64px] select-none bg-gradient-to-b from-black to-gray-300/80 dark:from-white dark:to-slate-900/40 hover:animate-pulse" href="/signup"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 137 137" class="size-6"><path fill="#000" d="M0 66.796C0 35.308 0 19.564 9.782 9.782 19.564 0 35.308 0 66.796 0h2.536c31.488 0 47.232 0 57.014 9.782 9.782 9.782 9.782 25.526 9.782 57.014v2.536c0 31.488 0 47.232-9.782 57.014-9.782 9.782-25.526 9.782-57.014 9.782h-2.536c-31.488 0-47.232 0-57.014-9.782C0 116.564 0 100.82 0 69.332v-2.536z"></path><path fill="#000" fill-rule="evenodd" d="M69.332 5.566h-2.536c-15.901 0-27.267.012-35.905 1.173-8.477 1.14-13.489 3.295-17.173 6.979-3.684 3.684-5.839 8.695-6.979 17.173-1.16 8.638-1.173 20.004-1.173 35.905v2.536c0 15.901.012 27.267 1.173 35.905 1.14 8.477 3.295 13.488 6.979 17.173 3.684 3.684 8.695 5.838 17.173 6.978 8.638 1.161 20.004 1.173 35.905 1.173h2.536c15.901 0 27.267-.012 35.905-1.173 8.477-1.14 13.488-3.294 17.173-6.978 3.684-3.685 5.838-8.696 6.978-17.173 1.161-8.638 1.173-20.004 1.173-35.905v-2.536c0-15.901-.012-27.267-1.173-35.905-1.14-8.477-3.294-13.489-6.978-17.173-3.685-3.684-8.696-5.839-17.173-6.979-8.638-1.16-20.004-1.173-35.905-1.173zM9.782 9.782C0 19.564 0 35.308 0 66.796v2.536c0 31.488 0 47.232 9.782 57.014 9.782 9.782 25.526 9.782 57.014 9.782h2.536c31.488 0 47.232 0 57.014-9.782 9.782-9.782 9.782-25.526 9.782-57.014v-2.536c0-31.488 0-47.232-9.782-57.014C116.564 0 100.82 0 69.332 0h-2.536C35.308 0 19.564 0 9.782 9.782z" clip-rule="evenodd"></path><path fill="#fff" d="M93.66 26.178c-8.982 0-16.288 7.307-16.288 16.29v6.98H58.756v-6.98c0-8.983-7.307-16.29-16.289-16.29-8.982 0-16.289 7.307-16.289 16.29 0 8.981 7.307 16.288 16.29 16.288h6.98v18.616h-6.98c-8.983 0-16.29 7.306-16.29 16.288 0 8.983 7.307 16.289 16.29 16.289 8.981 0 16.288-7.306 16.288-16.288V86.68h18.616v6.98c0 8.983 7.306 16.289 16.288 16.289 8.983 0 16.289-7.306 16.289-16.288 0-8.983-7.306-16.29-16.289-16.29h-6.98V58.757h6.98c8.983 0 16.289-7.307 16.289-16.289 0-8.982-7.306-16.289-16.289-16.289zm-6.98 23.27v-6.98a6.972 6.972 0 016.98-6.982 6.971 6.971 0 016.981 6.981 6.971 6.971 0 01-6.98 6.981H86.68zm-44.213 0a6.972 6.972 0 01-6.98-6.98 6.972 6.972 0 016.98-6.982 6.972 6.972 0 016.981 6.981v6.981h-6.98zm16.289 27.924V58.756h18.616v18.616H58.756zM93.66 100.64a6.971 6.971 0 01-6.98-6.98v-6.98h6.98a6.971 6.971 0 016.981 6.98 6.971 6.971 0 01-6.98 6.981zm-51.193 0a6.971 6.971 0 01-6.98-6.98 6.972 6.972 0 016.98-6.981h6.981v6.98a6.971 6.971 0 01-6.98 6.981z"></path></svg><span class="text-lg flex gap-2 justify-start items-center"><span>Get started</span></span></a>

        <div class="w-full sm:w-auto"  ><button class="font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring-muted-foreground/25 focus:ring-1 focus:ring-muted-foreground/25 disabled:pointer-events-none disabled:opacity-50 cursor-pointer gap-2 group hover:text-accent-foreground px-4 py-2 gap-x-1 flex items-center justify-center w-full h-[56px] sm:h-[64px] text-lg text-muted-foreground hover:bg-transparent group ring-0 outline-none rounded-full select-none" type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="radix-:rh:" data-state="closed"><svg class="h-5 w-5 flex-none fill-white group-active:fill-current mr-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M4 4C4 3.44772 4.44772 3 5 3H19C19.5523 3 20 3.44772 20 4C20 4.55228 19.5523 5 19 5H5C4.44772 5 4 4.55228 4 4ZM2 10C2 7.79086 3.79086 6 6 6H18C20.2091 6 22 7.79086 22 10V17C22 19.2091 20.2091 21 18 21H6C3.79086 21 2 19.2091 2 17V10ZM10.5668 10.5987C10.9133 10.4322 11.3245 10.479 11.6247 10.7191L14.1247 12.7191C14.3619 12.9089 14.5 13.1962 14.5 13.5C14.5 13.8038 14.3619 14.0911 14.1247 14.2809L11.6247 16.2809C11.3245 16.521 10.9133 16.5678 10.5668 16.4013C10.2203 16.2348 10 15.8844 10 15.5V11.5C10 11.1156 10.2203 10.7652 10.5668 10.5987Z" fill="currentColor"></path></svg><span>Video demo</span></button></div>
        </div>
      </div>
    </section>
  );
