...
export default function Features() {
  const features = [
    { name: "Command.new — Vibe Code AI Agents", href: "https://command.new", primary: true },
    { name: "Tools", href: "https://BaseAI.dev/learn", primary: false },
    { name: "Generate", href: "https://langbase.com/docs/features/generate", primary: true },
    { name: "Chat", href: "https://langbase.com/docs/features/chat", primary: false },
    { name: "Prompt Engineering", href: "https://langbase.com/docs/features/prompt", primary: true },
    { name: "Versioning", href: "https://langbase.com/docs/features/versions", primary: true },
    { name: "Streaming", href: "https://langbase.com/docs/features/stream", primary: true },
    { name: "Few Shot Training", href: "https://langbase.com/docs/features/few-shot", primary: false },
    { name: "Messages Storage", href: "https://langbase.com/docs/features/store-messages", primary: true },
    { name: "Moderation", href: "https://langbase.com/docs/features/moderation", primary: false },
    { name: "Fork", href: "https://langbase.com/docs/features/fork", primary: true },
    { name: "Usage Prediction", href: "https://langbase.com/docs/features/usage", primary: false },
    { name: "Keysets", href: "https://langbase.com/docs/features/keysets", primary: true },
    { name: "Presets", href: "https://langbase.com/docs/features/model-presets", primary: false },
    { name: "JSON Mode", href: "https://langbase.com/docs/features/json-mode", primary: true },
    { name: "Safety", href: "https://langbase.com/docs/features/safety", primary: false }
  ];
  ...
  return (
    <section className="group text-white h-full cursor-pointer relative row-span-1 flex flex-col justify-between overflow-hidden rounded-[2.25rem] bg-black shadow-[0_2px_3px_0_theme(colors.black/65%),0_0_0_1px_theme(colors.white/10%),0_-1px_0_0_theme(colors.white/15%)] transform-gpu col-span-4 lg:col-span-2">
      ...
      <div className="pointer-events-none absolute bottom-0 flex w-full translate-y-10 transform-gpu flex-row items-center p-4 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100 z-[999]">
        ...
        >
          Click any feature above to learn more
