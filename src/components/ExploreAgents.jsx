  ...
  return (
    <div className="group text-white h-full cursor-pointer relative row-span-1 flex flex-col justify-between overflow-hidden rounded-[2.25rem] bg-black shadow-[0_2px_3px_0_theme(colors.black/65%),0_0_0_1px_theme(colors.white/10%),0_-1px_0_0_theme(colors.white/15%)] transform-gpu col-span-4 lg:col-span-1">
      <div className="w-full h-full z-1">
        <div className="absolute inset-0 [mask-image:linear-gradient(to_top,transparent_35%,#000_70%)]">
          <div className="relative mx-auto flex max-h-[400px] min-h-[400px] w-full max-w-[32rem] flex-col overflow-hidden p-6">
            <div className="flex flex-col items-center gap-4 undefined">
              <div className="mx-auto w-full" style={{ opacity: 1, willChange: 'auto', transform: 'none', transformOrigin: '50% 0% 0px' }}>
                <figure className="relative mx-auto min-h-fit w-full max-w-[400px] cursor-pointer overflow-hidden rounded-2xl p-4 bg-background transition-all duration-200 ease-in-out hover:scale-[103%] transform-gpu dark:bg-transparent dark:backdrop-blur-md shadow-[0_2px_3px_0_theme(colors.black/65%),0_0_0_1px_theme(colors.white/10%),0_-1px_0_0_theme(colors.white/15%)]">
                  <div className="flex flex-row items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-2xl" style={{ backgroundColor: 'rgb(0, 0, 0)' }}>
                      <span className="text-lg">
                        <svg width="20" height="22" viewBox="0 0 14 16" xmlns="http://www.w3.org/2000/svg">
                          <path d="M11.69 9.50344C12.69 9.50344 13.5 10.3134 13.5 11.3134V12.0024H13.495C13.461 12.7824 13.247 13.7594 12.372 14.5574C11.416 15.4304 9.765 16.0004 7 16.0004C4.234 16.0004 2.584 15.4304 1.628 14.5574C0.753 13.7594 0.539 12.7814 0.505 12.0024H0.5V11.3124C0.5 10.3134 1.31 9.50344 2.31 9.50344H11.69ZM3.5 1.00044C3.10218 1.00044 2.72064 1.15847 2.43934 1.43978C2.15804 1.72108 2 2.10261 2 2.50044V6.50044C2 6.89826 2.15804 7.27979 2.43934 7.5611C2.72064 7.8424 3.10218 8.00043 3.5 8.00043H10.5C10.8978 8.00043 11.2794 7.8424 11.5607 7.5611C11.842 7.27979 12 6.89826 12 6.50044V2.50044C12 2.10261 11.842 1.72108 11.5607 1.43978C11.2794 1.15847 10.8978 1.00044 10.5 1.00044H7.5V0.500435C7.50283 0.434019 7.49183 0.367739 7.46771 0.305796C7.44358 0.243852 7.40685 0.187595 7.35985 0.140589C7.31284 0.093583 7.25658 0.0568533 7.19464 0.0327273C7.1327 0.00860139 7.06642 -0.0023949 7 0.000435221C6.724 0.000435221 6.5 0.230435 6.5 0.500435V1.00044H3.5ZM4 4.50044C4 4.23522 4.10536 3.98086 4.29289 3.79333C4.48043 3.60579 4.73478 3.50044 5 3.50044C5.26522 3.50044 5.51957 3.60579 5.70711 3.79333C5.89464 3.98086 6 4.23522 6 4.50044C6 4.76565 5.89464 5.02001 5.70711 5.20754C5.51957 5.39508 5.26522 5.50044 5 5.50044C4.73478 5.50044 4.48043 5.39508 4.29289 5.20754C4.10536 5.02001 4 4.76565 4 4.50044ZM8 4.50044C8 4.23522 8.10536 3.98086 8.29289 3.79333C8.48043 3.60579 8.73478 3.50044 9 3.50044C9.26522 3.50044 9.51957 3.60579 9.70711 3.79333C9.89464 3.98086 10 4.23522 10 4.50044C10 4.76565 9.89464 5.02001 9.70711 5.20754C9.51957 5.39508 9.26522 5.50044 9 5.50044C8.73478 5.50044 8.48043 5.39508 8.29289 5.20754C8.10536 5.02001 8 4.76565 8 4.50044Z" fill="#f2f2f2"></path>
                        </svg>
                      </span>
                    </div>
                    <div className="flex flex-col overflow-hidden">
                      <figcaption className="flex flex-row items-center whitespace-pre text-lg font-medium text-primary">
                        <span className="text-sm">Support Ticket Bot</span>
                      </figcaption>
              ...
              <div className="mx-auto w-full" style={{ opacity: 1, willChange: 'auto', transform: 'translate3d(0px, -0.106413px, 0px)', transformOrigin: '50% 0% 0px' }}>
                <figure className="relative mx-auto min-h-fit w-full max-w-[400px] cursor-pointer overflow-hidden rounded-2xl p-4 bg-background transition-all duration-200 ease-in-out hover:scale-[103%] transform-gpu dark:bg-transparent dark:backdrop-blur-md shadow-[0_2px_3px_0_theme(colors.black/65%),0_0_0_1px_theme(colors.white/10%),0_-1px_0_0_theme(colors.white/15%)]">
                        <div className="flex flex-row items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-2xl" style={{ backgroundColor: 'rgb(0, 0, 0)' }}>
                            <span className="text-lg">
                    ...
                    <div className="flex flex-col overflow-hidden">
                      <figcaption className="flex flex-row items-center whitespace-pre text-lg font-medium text-primary">
                        <span className="text-sm">Market Analyst</span>
                      </figcaption>
                      <p className="text-xs font-normal text-muted-foreground">Langbase Pipe</p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-row items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-2xl" style={{ backgroundColor: 'rgb(0, 0, 0)' }}>
                      <span className="text-lg">
                          ...
                          <div className="flex flex-col overflow-hidden">
                            <figcaption className="flex flex-row items-center whitespace-pre text-lg font-medium text-primary">
                        <span className="text-sm">AWS Guru</span>
                            </figcaption>
                            <p className="text-xs font-normal text-muted-foreground">Langbase Pipe</p>
                          </div>
                        </div>
                    ...
                    <div className="flex h-10 w-10 items-center justify-center rounded-2xl" style={{ backgroundColor: 'rgb(0, 0, 0)' }}>
                      <span className="text-lg">
                        <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M6 17H14M1 13V9C1 5.229 1 3.343 2.172 2.172C3.344 1.001 5.229 1 9 1H11C14.771 1 16.657 1 17.828 2.172C18.999 3.344 19 5.229 19 9V13C19 16.771 19 18.657 17.828 19.828C16.656 20.999 14.771 21 11 21H9C5.229 21 3.343 21 2.172 19.828C1.001 18.656 1 16.771 1 13Z" stroke="#f2f2f2" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                          <path d="M5.04965 5.97656H14.9566M10.0146 5.97656V12.9826M10.0146 12.9826H9.48165M10.0146 12.9826H10.5406M6.01565 6.96456C5.28965 7.71056 4.08765 8.99656 4.61365 10.0676C5.08065 11.0186 5.74465 11.0356 6.01465 11.0356C6.28465 11.0356 6.98765 11.0186 7.45465 10.0676C7.98065 8.99656 6.74165 7.71056 6.01565 6.96456ZM13.9806 6.96456C13.2556 7.71056 12.0536 8.99656 12.5786 10.0676C13.0456 11.0186 13.7106 11.0356 13.9806 11.0356C14.2506 11.0356 14.9536 11.0186 15.4206 10.0676C15.9466 8.99656 14.7066 7.71056 13.9806 6.96456Z" stroke="#f2f2f2" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                        </svg>
                      </span>
                    </div>
                    <div className="flex flex-col overflow-hidden">
                      <figcaption className="flex flex-row items-center whitespace-pre text-lg font-medium text-primary">
                        <span className="text-sm">Legal Chatbot</span>
                      </figcaption>
                      <p className="text-xs font-normal text-muted-foreground">Langbase Pipe</p>
                    </div>
                </div>
        ...
        <p className="mt-1 pr-[1rem] max-w-lg text-muted-foreground/90">Fork thousands of open-source AI agents built by developers community.</p>
          </div>
      <div className="pointer-events-none absolute bottom-0 flex w-full translate-y-10 transform-gpu flex-row items-center p-4 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100 z-[999]">
        <a href="https://langbase.com/explore" className="inline-flex items-center justify-center font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring-muted-foreground/25 focus:ring-1 focus:ring-muted-foreground/25 disabled:pointer-events-none disabled:opacity-50 select-none cursor-pointer gap-2 group hover:bg-accent hover:text-accent-foreground h-8 rounded-lg px-3 text-xs pointer-events-auto">
              Learn more
