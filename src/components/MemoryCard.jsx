...
const MemoryCard = () => {
  return (
    <div className="group h-full text-white cursor-pointer relative row-span-1 flex flex-col justify-between overflow-hidden rounded-[2.25rem] bg-black shadow-[0_2px_3px_0_theme(colors.black/65%),0_0_0_1px_theme(colors.white/10%),0_-1px_0_0_theme(colors.white/15%)] transform-gpu col-span-4 lg:col-span-2">
      <div className="w-full h-full z-1">
        <div className="absolute top-5 inset-0 origin-top transition-all duration-300 ease-out group-hover:scale-105 flex justify-center align-center w-full">
          <div className="relative flex w-full mt-1 mx-6 h-3/5 flex-col items-center justify-center overflow-hidden rounded-3xl bg-transparent bg-white [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] transform-gpu dark:bg-transparent dark:backdrop-blur-md dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] shadow-[0_2px_3px_0_theme(colors.black/65%),0_0_0_1px_theme(colors.white/10%),0_-1px_0_0_theme(colors.white/15%)]">
            ...
            <div className="mx-auto w-max mt-5 h-[50px] p-2 flex items-end gap-3 rounded-2xl">
              <div className="flex p-2.5 aspect-square cursor-pointer items-center justify-center rounded-xl bg-black" style={{width: '45px'}}>
      ...
      {/* Title/Description */}
      <div className="pointer-events-none flex transform-gpu flex-col gap-1 p-6 transition-all duration-300 group-hover:-translate-y-10 z-1">
