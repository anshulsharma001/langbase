const Explore = () => {
  return (
    <>
      <div className="flex w-full flex-col items-center rounded-lg mt-12 mx-auto">
        <div className="w-full flex flex-col items-center gap-10 px-4 md:px-0">
          ...
          <div className="w-full flex flex-col items-center relative">
            ...
            <div className="flex justify-center gap-y-2 flex-wrap w-full lg:w-2/4 text-sm z-10 mt-8 sm:mt-12">
              ...
              >
                <div className="flex items-center justify-center space-x-1 border border-border rounded-lg px-3 py-1 bg-muted cursor-pointer hover:bg-foreground hover:text-background">
                  Legal
                </div>
              </a>
              <a
